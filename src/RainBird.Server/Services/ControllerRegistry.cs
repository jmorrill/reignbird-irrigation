...
public sealed class ControllerConnection : IDisposable
{
    ...
    /// unless somebody writes one — either through this app, which clears this, or at
    ...
    /// the endpoint so the one thing worth getting wrong — serving a program the user
    /// has just edited — can be tested directly.
    /// </summary>
    ...
    /// in origin — it could be the controller's own schedule or someone at the panel.
    /// </summary>
